...
router.post('/OBT/elective-care/feature-design/AC-687_lft_and_pcr/v3/patient-testing-portal/PCR/bulk-or-1by1-v1', function (req, res) {
  let answer = req.body.cuUploadType;

  if (answer == 'bulk') {
    res.redirect('/OBT/elective-care/feature-design/AC-687_lft_and_pcr/v3/patient-testing-portal/PCR/bulk-upload-v1')
  } else if (answer == '1by1') {
      res.redirect('/OBT/elective-care/feature-design/AC-687_lft_and_pcr/v3/patient-testing-portal/PCR/1by1-procedure-date-v1')
    } else {
    res.redirect('/OBT/elective-care/feature-design/AC-687_lft_and_pcr/v3/patient-testing-portal/PCR/bulk-or-1by1-v1-e1')
    }
});

router.post('/OBT/elective-care/feature-design/AC-687_lft_and_pcr/v3/patient-testing-portal/PCR/bulk-or-1by1-v1-e1', function (req, res) {
  let answer = req.body.cuUploadType;
...
router.post('/OBT/elective-care/feature-design/AC-687_lft_and_pcr/v3/patient-testing-portal/LFT/bulk-or-1by1-v1', function (req, res) {
  let answer = req.body.cuUploadType;

  if (answer == 'bulk') {
    res.redirect('/OBT/elective-care/feature-design/AC-687_lft_and_pcr/v3/patient-testing-portal/LFT/bulk-upload-v1')
  } else if (answer == '1by1') {
      res.redirect('/OBT/elective-care/feature-design/AC-687_lft_and_pcr/v3/patient-testing-portal/LFT/1by1-procedure-date-v1')
    } else {
    res.redirect('/OBT/elective-care/feature-design/AC-687_lft_and_pcr/v3/patient-testing-portal/LFT/bulk-or-1by1-v1-e1')
    }
});

router.post('/OBT/elective-care/feature-design/AC-687_lft_and_pcr/v3/patient-testing-portal/LFT/bulk-or-1by1-v1-e1', function (req, res) {
  let answer = req.body.cuUploadType;
